...
impl CPU {
    ...
    match first_nibble {
      ...
      0x8 => {
        ...
        match operation {
          ...
          5 => {
            self.register[0xF] = if self.register[x as usize] > self.register[y as usize] {
              1
            } else {
              0
            };
          ...
          7 => {
            self.register[0xF] = if self.register[y as usize] > self.register[x as usize] {
              1
            } else {
              0
            };
  ...
  pub fn increment_stack_pointer(mut self) { self.stack_pointer += 1; }
}
